...
[^knitr-python-install]: 用户在安装好 reticulate 包后需使用 `py_install("package")` 样式的代码来安装需要使用的 Python 程序包。如 `py_install("pandas")` 代码会安装 pandas 程序包。再以下的例子中，用户需要提前安装 pandas 和 seaborn 两个 Python 安装包，否则 R 会报错。
