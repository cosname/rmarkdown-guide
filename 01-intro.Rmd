...
我们在 \@ref(basic-other-languages) 给出了一个更完整的交替使用 R 和 Python 做数据分析的例子，并在 \@ref(other-languages) 中讨论了如何在 R Markdown 中结合其他编程语言。
...
本章回顾了 R Markdown 在技术工具层面的渊源和它的发展历史。喜欢直接进入实操的读者可以跳过本节，从 第 \@ref(installation) 章开始。如果读者已经掌握了 R Markdown 的基础知识，书写过一些 R Markdown 的文档, 也可以直接开始阅读第 \@ref(document) 章。
