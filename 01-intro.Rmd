...
除了提供模板外， R Markdown 还能让你的简历变得更加"数据驱动"。[datadrivencv](http://nickstrayer.me/datadrivencv/) 包把简历中的各项教育背景，工作经历和项目经验等视作电子表格中的一条记录，我们可以仅维护这张数据表，R Markdown 负责简历的格式。我们还可以插入 R 代码生成的交互图表，让我们的简历动起来。图 \@ref(ns-cv) 是 datadrivencv 包的作者 Nick Strayer 结合 **pagedown** 包 [@R-pagedown] 制作的个人简历。
