...
R Markdown 及 bookdown 文档可运行代码，格式化长篇文本，插入 LaTeX 数学环境，支持交叉引用，特别适合统计，数据科学，计算机科学等领域的学生，研究人员和爱好者们作为首选的笔记本格式。[RPubs](https://rpubs.com/) 等网页发布平台提供了免费的部署服务，我们可以以易读的格式发布自己的笔记与心得，记录一步步学习历程，便利他人和未来的自己。
...
除了使用模板外， R Markdown 还能让你的简历变得更加“数据驱动”。[datadrivencv](http://nickstrayer.me/datadrivencv/) 包 [@R-datadrivencv] 把简历中的各项教育背景，工作经历和项目经验等视作电子表格中的一条记录，我们可以仅维护这张数据表，R Markdown 负责简历的格式。除此之外，还可以插入 R 代码生成的交互图表，让我们的简历动起来。图 \@ref(ns-cv) 是 datadrivencv 包的作者 Nick Strayer 结合 pagedown 包制作的个人简历。
