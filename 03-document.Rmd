...
`darkly` 主题样式的效果如图 \@ref(fig:first-rmd-theme-darkly) 所示，感兴趣的读者可以自行尝试其它样式。
...
```{r html-code-highlight-example, fig.cap="(ref:figcap-html-code-highlight-example)", fig.show="hold", out.width="70%", echo=FALSE, echo=FALSE}
...
| 取值     | 说明         |
|-------  |--------------|
| default | 使用 `print.data.frame` 函数|
