...
knitr::kable(data.frame(取值 = c("default", "kable", "tibble", "paged"),
...
```{r, echo = FALSE, fig.cap = "用自定义函数控制数据框的打印格式"}
...
knitr::kable(data.frame(参数名 = c("max.print", "rows.print", "cols.print", "cols.min.print", "pages.print", "paged.print","rownames.print"),
...
knitr::kable(data.frame(变量名称 = c("lang", "fontsize", "documentclass", "classoption", "geometry", "mainfont, sansfont, monofont, mathfont","linkcolor, urlcolor, citecolor"),
...
```{r xaringan-themer-sample-view, echo=FALSE,fig.width=6,fig.align='center', fig.cap="xaringanthemer 包提供的主题示例"}
...
```{r xaringan-themer-ggplot, echo=FALSE, fig.width=6, fig.align='center', fig.cap="xaringanthemer 包提供的 ggplot2 色板"}
