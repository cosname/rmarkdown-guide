...
一群Rmd爱好者来翻译谢大的 [**R Markdown Cookbook**](https://bookdown.org/yihui/rmarkdown-cookbook/)
...
# 安装需要的包
# 加了会报错：'tikizDevice','rgl'
xfun::pkg_load2(c('formatR', 'kableExtra', 'magick', 'knitr', 'tinytex', 'codetools', 'remotes', 'rmarkdown', 'pander'))
